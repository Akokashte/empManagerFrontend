...
const FeedbackCard = ({ getEmployeeFeedbacks, getAllEmployeeFeedbacks, feedback, setAddFeedbackClicked }) => {
    ...
    const handleDelete = async (feedbackId) => {
        try {
            const res = await axios.delete("http://localhost:5000/api/v1/feedback/delete",
                {
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            const res = await axios.patch("http://localhost:5000/api/v1/feedback/update",
                {
                    feedbackId,
